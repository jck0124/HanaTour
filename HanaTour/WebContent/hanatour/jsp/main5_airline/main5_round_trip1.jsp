...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/hanatour/css/main5_round_trip1.css">
</head>
<body>
	...
	<form action="${pageContext.request.contextPath}/FlightController" class="round_trip_select1">
		<input type="hidden" name="command" value="airlineRoundtrip2"/>
...
<script src="${pageContext.request.contextPath}/hanatour/script/main5_round_trip1.js"></script>
