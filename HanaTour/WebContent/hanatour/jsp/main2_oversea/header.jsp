...
<script src="${pageContext.request.contextPath}/hanatour/script_jsp/main_type.js"></script>
<script src="${pageContext.request.contextPath}/hanatour/script_jsp/main1_home.js"></script>
