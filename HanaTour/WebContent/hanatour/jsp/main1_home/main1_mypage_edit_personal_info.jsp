...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/hanatour/css/main1_mypage_edit_personal_info.css">
			...
			<div class="container_right">
                ...
                <div class="container_right_body">
                    ...
                    <form action="${pageContext.request.contextPath}/FlightController" method="post">
                    	<input type="hidden" name="command" value="editPersonalInfo2Entrance"/>
                            ...
                            <div class="container_right_body3_id">
                                ...
                                <div class ="container_right_body3_id_right">
                                    <input 
                                    	type="text" 
                                    	name="user_id" 
                                    	value="${sessionScope.loginId != null ? sessionScope.loginId : ''}"
                                    	disabled
                                    />
                                </div>
                            </div>
...
<script src="${pageContext.request.contextPath}/hanatour/script/main1_mypage_edit_personal_info.js"></script>
</html>
</html>