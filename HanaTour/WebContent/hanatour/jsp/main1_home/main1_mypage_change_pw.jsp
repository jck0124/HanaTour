...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/hanatour/css/main1_mypage_change_pw.css">
            ...
            <div class="container_right">
                ...
                <div class="container_right_body">
                    ...
                    <div class="container_right_body2">
                        <span>${sessionScope.loginName}</span> 님의 개인정보 보호를 위해<br/>비밀번호를 주기적으로 변경해 주세요.
                    </div>
...
<script src="${pageContext.request.contextPath}/hanatour/script/main1_mypage_change_pw.js"></script>
</html>
</html>