$(function() {
	...
	$(".airline_ticket_select_btn").click(function(e) {
		...
		$("input[name='roundtrip_airline_ticket1']").val(ticketIdx);
	...
	function airlineTicektSort() {
		...
		$.ajax({
			...
			dataType: "json",
			success: function() {
				console.log("airlineTicektSort success");
			}, error: function() {
				console.log("airlineTicektSort error");
			}, complete: function() {
				console.log("airlineTicektSort complete");
			}
