 $(function() {
	...
	$(".airline_reservation_btn").click(function() {
		...
		console.log("티켓1idx : " + $("input[name='roundtrip_airline_ticket1']").val());
		console.log("티켓2idx : " + $("input[name='roundtrip_airline_ticket2']").val());
		*/
